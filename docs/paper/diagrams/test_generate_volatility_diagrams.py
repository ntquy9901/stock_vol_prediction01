"""Smoke test for the volatility architecture/ablation SVG generator.
...
import generate_volatility_diagrams as g  # noqa: E402
...
def test_diagrams_generate_valid_svgs(tmp_path, monkeypatch):
    ...
    g.diagram_ablation()
    for name in ("volatility_architecture.svg", "volatility_ablation.svg"):
        svg = tmp_path / name
