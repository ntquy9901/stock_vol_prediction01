...
Authoritative architecture source:
  baselines/2026-08-15_volatility/design/ARCHITECTURE_DETAILED.md

Run (venv):
  C:/luanvan/stock_vol_prediction01/.venv_gpu_encode/Scripts/python.exe \
      docs/paper/diagrams/generate_volatility_diagrams.py

Outputs:
  docs/paper/diagrams/volatility_architecture.svg   (FIG 1: full model)
  docs/paper/diagrams/volatility_ablation.svg       (FIG 2: leave-one-out ablation)
"""
import matplotlib
matplotlib.use("Agg")
...
def diagram_full_model():
    ...
    save(fig, "volatility_architecture.svg")
...
def diagram_ablation():
    ...
    save(fig, "volatility_ablation.svg")
