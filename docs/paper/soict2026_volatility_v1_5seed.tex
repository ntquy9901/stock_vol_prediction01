...
% Content = the finalized five-seed draft docs/paper/volatility_paper_draft_5seed.md.
...
% Figures are the PDF renders of docs/paper/diagrams/generate_volatility_diagrams.py
%   (volatility_architecture.pdf, volatility_ablation.pdf).
%
