...
walk-forward validation and averaged over three seeds (a stability check). VolTree denotes the full model with both earnings features (E) and leaf-graph smoothing (LG);
