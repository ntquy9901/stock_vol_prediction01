...
We start with the full VolTree model and remove one or both components, as shown in Table~\ref{tab:detail}. \textbf{VolTree} includes both earnings features and leaf-graph smoothing. \textbf{VolTree w/o E} removes the earnings block and retains the endogenous features and leaf graph. \textbf{VolTree w/o LG} removes leaf-graph smoothing and retains the endogenous and earnings features. Finally, \textbf{VolTree w/o E and LG} removes both components and serves as the endogenous-only baseline. For brevity, we refer to VolTree w/o LG as the \emph{earnings variant} and VolTree w/o E as the \emph{leaf-graph variant}. This ablation evaluates the contribution of each component and shows how its effect differs between markets.
...
earnings variant has the lowest QLIKE in every block---while leaf-graph smoothing self-disables. On HOSE the pattern
...
walk-forward validation. VolTree denotes the full model with both earnings features (E) and leaf-graph smoothing (LG);
...
$10^{-3}$, and QLIKE is unscaled; all metrics are lower-is-better. For the QLIKE comparisons (Section~\ref{sec:robust}), $^{*}$ indicates a
...
1 & VolTree              & 0.555 & 0.745 & 0.207 & 0.3458 & 0.533 & 0.730 & 0.390 & 1.5640 \\
1 & VolTree w/o E        & 0.557 & 0.746 & 0.209 & 0.3573 & 0.534 & 0.730 & 0.390 & 1.5640$^{*}$ \\
1 & VolTree w/o LG       & 0.554 & 0.744 & 0.208 & 0.3457$^{*}$ & 0.534 & 0.731 & 0.392 & 1.5675 \\
1 & VolTree w/o E and LG & 0.558 & 0.747 & 0.209 & 0.3573 & 0.534 & 0.731 & 0.392 & 1.5675 \\
\midrule
5 & VolTree              & 0.612 & 0.782 & 0.225 & 0.3995 & 0.578 & 0.760 & 0.423 & 1.6455 \\
5 & VolTree w/o E        & 0.613 & 0.783 & 0.226 & 0.4122 & 0.578 & 0.760 & 0.423 & 1.6455$^{*}$ \\
5 & VolTree w/o LG       & 0.611 & 0.782 & 0.225 & 0.3992$^{*}$ & 0.578 & 0.760 & 0.425 & 1.6474 \\
5 & VolTree w/o E and LG & 0.613 & 0.783 & 0.226 & 0.4121 & 0.578 & 0.760 & 0.425 & 1.6474 \\
\midrule
10 & VolTree              & 0.629 & 0.793 & 0.231 & 0.4184 & 0.594 & 0.771 & 0.438 & 1.6815 \\
10 & VolTree w/o E        & 0.631 & 0.794 & 0.232 & 0.4312 & 0.594 & 0.771 & 0.438 & 1.6814$^{\dagger}$ \\
10 & VolTree w/o LG       & 0.628 & 0.793 & 0.231 & 0.4182$^{*}$ & 0.595 & 0.771 & 0.439 & 1.6818 \\
10 & VolTree w/o E and LG & 0.631 & 0.794 & 0.232 & 0.4311 & 0.595 & 0.771 & 0.439 & 1.6816 \\
\midrule
22 & VolTree              & 0.621 & 0.788 & 0.234 & 0.4340 & 0.621 & 0.788 & 0.458 & 1.7252 \\
22 & VolTree w/o E        & 0.623 & 0.789 & 0.236 & 0.4459 & 0.621 & 0.788 & 0.458 & 1.7250$^{\dagger}$ \\
22 & VolTree w/o LG       & 0.621 & 0.788 & 0.234 & 0.4340$^{*}$ & 0.621 & 0.788 & 0.459 & 1.7253 \\
22 & VolTree w/o E and LG & 0.623 & 0.789 & 0.236 & 0.4459 & 0.621 & 0.788 & 0.459 & 1.7251 \\
\bottomrule
\end{tabular}
\end{table}
