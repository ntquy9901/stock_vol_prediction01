...
to the broader, more actively traded VN100 panel at the daily horizon.
...
MAE and $R^2$; the learned models are trained with the MSE loss, and QLIKE is used only for evaluation.
...
QLIKE results are reported with their exact $p$-values as exploratory findings.
