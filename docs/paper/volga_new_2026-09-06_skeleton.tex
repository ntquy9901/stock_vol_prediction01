...
\subsection{VN30}
% PLACEHOLDER: fill from edgehm_vn30_h*.json (run in progress). Table \input{tables/vn30_tables.tex}.
...
VN100 [VN30 and S\&P 500 pending], from the train-to-test QLIKE and R\textsuperscript{2} gaps that
