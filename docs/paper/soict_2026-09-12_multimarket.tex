...
$h1$, $h5$, $h10$, $h22$). The own-history GBM therefore carries the bolded QLIKE in every block.
...
unscaled. Bold marks the best value in each metric column per horizon; the QLIKE bold additionally
requires a significant date-clustered Diebold-Mariano test ($p<0.05$).}
\label{tab:hose}
\footnotesize
\setlength{\tabcolsep}{6pt}
\begin{tabular}{llcccc}
