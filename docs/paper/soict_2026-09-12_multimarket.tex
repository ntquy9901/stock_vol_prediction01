...
\subsection*{Features}
\textbf{Own-history block (9 features, used by GBM).} Every own-history feature is observable at the
...
\end{align}
A realized-quarticity proxy gauges the magnitude and dispersion of recent variance, which lets the
model down-weight noisy high-variance periods:
\begin{equation}
\mathrm{rq}_t = \sqrt{\tfrac{1}{5}\sum_{k=0}^{4}\mathrm{pk}_{t-k}^{2}}.
\end{equation}
...
days and activates only in the roughly two-week window around a scheduled release. An event study
(Fig.~\ref{fig:event}) shows the S\&P~500 median variance rises to about 2.75 times baseline on the
announcement day, which motivates these windows; on HOSE the median stays flat, so the block is inert
there.

\begin{figure}[t]
\centering
\includegraphics[width=0.7\textwidth]{fig_earnings_event_study.png}
\caption{Median Parkinson variance around scheduled earnings, normalized to the pre-window baseline.
The S\&P~500 median rises to about 2.75 times baseline on the announcement day, while the HOSE median
stays flat.}
\label{fig:event}
\end{figure}
...
1 & GBME       & \textbf{5.397} & \textbf{7.346} & 2.017 & \textbf{0.3172} \\
1 & GBME+graph & 5.424 & 7.365 & \textbf{2.010} & 0.3158 \\
\midrule
5 & HAR        & 6.141 & 7.836 & 2.297 & 0.4364 \\
5 & HARQ       & 6.132 & 7.831 & 2.309 & 0.4377 \\
5 & GBM        & 6.117 & 7.821 & 2.255 & 0.4116 \\
5 & GBME       & \textbf{5.972} & \textbf{7.728} & \textbf{2.180} & \textbf{0.3705} \\
...
10 & GBME       & \textbf{6.118} & \textbf{7.822} & \textbf{2.239} & \textbf{0.3912} \\
...
22 & GBME       & 6.098 & 7.809 & \textbf{2.277} & \textbf{0.4074} \\
22 & GBME+graph & \textbf{6.087} & \textbf{7.802} & 2.300 & 0.4110 \\
\bottomrule
\end{tabular}
\end{table}
...
1 & GBM        & \textbf{5.399} & \textbf{7.348} & \textbf{3.944} & \textbf{1.5679} \\
...
5 & GBME       & \textbf{5.795} & \textbf{7.613} & 4.276 & 1.6485 \\
5 & GBME+graph & 5.815 & 7.625 & \textbf{4.256} & 1.6494 \\
\midrule
...
10 & GBME+graph & \textbf{5.959} & \textbf{7.720} & \textbf{4.407} & 1.6837 \\
\midrule
...
22 & GBME+graph & \textbf{6.207} & \textbf{7.878} & \textbf{4.604} & 1.7267 \\
\bottomrule
\end{tabular}
\end{table}
