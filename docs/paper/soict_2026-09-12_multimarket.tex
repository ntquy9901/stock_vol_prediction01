...
% SP500 table (tab:sp500) numbers: docs/reports/2026-09-12_gbme_metrics_table.md (pending OWN-8 re-run).
\documentclass{llncs}
\usepackage{graphicx}
...
on every metric. MSE $\times10^{-7}$, RMSE/MAE $\times10^{-4}$; QLIKE unscaled. GNNHAR$-g$ is GNNHAR with
the graph removed ($A{=}I$). Bold marks the best value in each metric column per horizon; the QLIKE bold
additionally requires a significant date-clustered Diebold-Mariano test ($p<0.05$).}
\label{tab:sp500}
\footnotesize
...
1 & GBM        & 5.565 & 7.460 & 2.091 & 0.3572 \\
1 & GBME       & \textbf{5.405} & \textbf{7.352} & 2.018 & \textbf{0.3173} \\
1 & GBME+graph & 5.428 & 7.367 & \textbf{2.011} & 0.3159 \\
1 & GNNHAR     & 5.760 & 7.589 & 2.121 & 0.3749 \\
1 & GNNHAR$-g$ & 5.657 & 7.521 & 2.054 & 0.3695 \\
\midrule
5 & HAR        & 6.141 & 7.836 & 2.297 & 0.4364 \\
5 & HARQ       & 6.132 & 7.831 & 2.309 & 0.4377 \\
5 & GBM        & 6.111 & 7.818 & 2.258 & 0.4120 \\
5 & GBME       & \textbf{5.962} & \textbf{7.721} & \textbf{2.181} & \textbf{0.3709} \\
5 & GBME+graph & 6.058 & 7.783 & 2.199 & 0.3720 \\
5 & GNNHAR     & 6.379 & 7.987 & 2.330 & 0.4462 \\
5 & GNNHAR$-g$ & 6.155 & 7.845 & 2.228 & 0.4251 \\
\midrule
10 & HAR        & 6.214 & 7.883 & 2.356 & 0.4615 \\
10 & HARQ       & 6.205 & 7.877 & 2.358 & 0.4614 \\
10 & GBM        & 6.287 & 7.929 & 2.319 & 0.4311 \\
10 & GBME       & \textbf{6.149} & \textbf{7.842} & \textbf{2.247} & \textbf{0.3918} \\
10 & GBME+graph & 6.255 & 7.909 & 2.277 & 0.3946 \\
10 & GNNHAR     & 6.601 & 8.124 & 2.426 & 0.4767 \\
10 & GNNHAR$-g$ & 6.410 & 8.006 & 2.283 & 0.4478 \\
\midrule
22 & HAR        & 6.327 & 7.954 & 2.419 & 0.4855 \\
22 & HARQ       & 6.311 & 7.944 & 2.415 & 0.4831 \\
22 & GBM        & 6.234 & 7.896 & 2.360 & 0.4466 \\
22 & GBME       & 6.095 & 7.807 & \textbf{2.279} & \textbf{0.4078} \\
22 & GBME+graph & \textbf{6.085} & \textbf{7.801} & 2.303 & 0.4115 \\
22 & GNNHAR     & 6.353 & 7.971 & 2.414 & 0.4761 \\
22 & GNNHAR$-g$ & 6.246 & 7.903 & 2.339 & 0.4564 \\
\bottomrule
\end{tabular}
\end{table}
...
unscaled. GNNHAR$-g$ is GNNHAR without the graph ($A{=}I$); GNNHAR is reported at $h1$ and $h5$. Bold
...
1 & GBM        & \textbf{5.409} & \textbf{7.355} & \textbf{3.941} & \textbf{1.5702} \\
1 & GBME       & 5.455 & 7.386 & 3.955 & 1.5690 \\
1 & GBME+graph & 5.560 & 7.456 & 4.000 & 1.5970 \\
1 & GNNHAR     & 5.847 & 7.647 & 4.383 & 1.6823 \\
1 & GNNHAR$-g$ & 5.420 & 7.362 & 4.024 & 1.5800 \\
\midrule
5 & HAR        & 6.626 & 8.140 & 5.227 & 1.8218 \\
5 & HARQ       & 6.519 & 8.074 & 5.152 & 1.8075 \\
5 & GBM        & \textbf{5.795} & \textbf{7.612} & 4.270 & \textbf{1.6484} \\
5 & GBME       & 5.797 & 7.614 & 4.279 & 1.6489 \\
5 & GBME+graph & 5.821 & 7.630 & \textbf{4.253} & 1.6487 \\
5 & GNNHAR     & 6.162 & 7.850 & 4.687 & 1.7439 \\
5 & GNNHAR$-g$ & 5.803 & 7.618 & 4.293 & 1.6560 \\
\midrule
10 & HAR        & 6.660 & 8.161 & 5.250 & 1.8277 \\
10 & HARQ       & 6.589 & 8.118 & 5.198 & 1.8180 \\
10 & GBM        & 5.956 & 7.718 & 4.416 & \textbf{1.6840} \\
10 & GBME       & 5.960 & 7.720 & 4.429 & 1.6835 \\
10 & GBME+graph & \textbf{5.953} & \textbf{7.715} & \textbf{4.404} & 1.6842 \\
\midrule
22 & HAR        & 6.716 & 8.195 & 5.282 & 1.8355 \\
22 & HARQ       & 6.677 & 8.171 & 5.250 & 1.8299 \\
22 & GBM        & \textbf{6.213} & \textbf{7.882} & 4.615 & \textbf{1.7263} \\
22 & GBME       & 6.232 & 7.894 & 4.617 & 1.7261 \\
22 & GBME+graph & 6.217 & 7.885 & \textbf{4.595} & 1.7261 \\
\bottomrule
\end{tabular}
\end{table}
