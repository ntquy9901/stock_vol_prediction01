...
\title{VolGA: A Graph-Attention Network for Multi-Horizon Stock Volatility Forecasting}
...
\begin{abstract}
Forecasting daily stock-price volatility is a core input to risk management and option pricing. We evaluate \emph{VolGA} (Volatility Graph-Attention), a model that fuses a per-stock temporal branch with a graph-attention branch, for multi-horizon volatility forecasting, using Vietnam's Hanoi Stock
...
On the VN30, VN100 and S\&P 500 markets the linear HAR-X keeps the lowest QLIKE, consistent with its standing as a
...
($p$-value; favoured model in parentheses, V=VolGA, H=HAR-X; bold if $p<0.05$; unadjusted).}
\label{tab:dm}
\footnotesize
\setlength{\tabcolsep}{5pt}
% AUTHORITATIVE: generated by scripts/paper/build_hnx_tables.py (do not hand-edit numbers)
...
To see which model is best on each of these markets across volatility targets,
Tables~\ref{tab:est-vn100}--\ref{tab:est-sp500} compare the HAR-X and VolGA QLIKE (scale-invariant, so
comparable across estimators) under the Parkinson, Yang--Zhang and Rogers--Satchell targets. HAR-X keeps the
lower QLIKE under the two single-day estimators (Parkinson and Rogers--Satchell) at every horizon on all three
markets; VolGA is lower only under the smoothed Yang--Zhang target at a few longer horizons.

\begin{table}[t]
\centering
\caption{VN100 --- QLIKE (HAR-X vs VolGA) across the three estimators; lower is bold.}
\label{tab:est-vn100}
\footnotesize
\setlength{\tabcolsep}{5pt}
% AUTHORITATIVE: generated by scripts/paper/build_hnx_tables.py (do not hand-edit numbers)
\input{generated/tab_est_qlike_vn100.tex}
\end{table}

\begin{table}[t]
\centering
\caption{VN30 --- QLIKE (HAR-X vs VolGA) across the three estimators; lower is bold.}
\label{tab:est-vn30}
\footnotesize
\setlength{\tabcolsep}{5pt}
% AUTHORITATIVE: generated by scripts/paper/build_hnx_tables.py (do not hand-edit numbers)
\input{generated/tab_est_qlike_vn30.tex}
\end{table}

\begin{table}[t]
\centering
\caption{S\&P 500 --- QLIKE (HAR-X vs VolGA) across the three estimators; lower is bold.}
\label{tab:est-sp500}
\footnotesize
\setlength{\tabcolsep}{5pt}
% AUTHORITATIVE: generated by scripts/paper/build_hnx_tables.py (do not hand-edit numbers)
\input{generated/tab_est_qlike_sp500.tex}
\end{table}
...
target replaced by the two other published estimators defined in the Method --- the single-day Rogers--Satchell
and the windowed Yang--Zhang. QLIKE is scale-invariant, so it is comparable across targets;
Table~\ref{tab:abl-park} (Parkinson) is the reference. Yang--Zhang is a smoothed twenty-day level and is far easier to forecast, so its absolute QLIKE is
much lower and is not comparable to the single-day measures --- it is shown for completeness. Under the
single-day Rogers--Satchell target VolGA has the lower QLIKE on HNX at every reported horizon, and under
...
\begin{table}[t]
\centering
\caption{HNX --- Parkinson target (the main estimator; HAR-X vs the proposed model VolGA). MSE $\times10^{-7}$,
RMSE/MAE $\times10^{-4}$.}
\label{tab:abl-park}
\footnotesize
\setlength{\tabcolsep}{5pt}
% AUTHORITATIVE: generated by scripts/paper/build_hnx_tables.py (do not hand-edit numbers)
\input{generated/tab_abl_parkinson.tex}
\end{table}
...
\setlength{\tabcolsep}{5pt}
% AUTHORITATIVE: generated by scripts/paper/build_hnx_tables.py (do not hand-edit numbers)
\input{generated/tab_abl_yang_zhang.tex}
\end{table}
...
\setlength{\tabcolsep}{5pt}
% AUTHORITATIVE: generated by scripts/paper/build_hnx_tables.py (do not hand-edit numbers)
\input{generated/tab_abl_rogers_satchell.tex}
\end{table}
