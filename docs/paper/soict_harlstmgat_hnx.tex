...
high $H$, low $L$ and close $C$ ($\ln$ is the natural logarithm), each is a daily variance estimator:
\begin{align*}
...
\sigma^2_{\mathrm{YZ}} &= \sigma^2_{o}+k\,\sigma^2_{c}+(1-k)\,\overline{\sigma^2_{\mathrm{RS}}} && \text{(Yang--Zhang: windowed, $n{=}20$ days),}
\end{align*}
