...
hard-to-beat benchmark for large-cap markets, while the learned models significantly reduce the absolute error: on VN100 the
VolGA (or the no-graph LSTM) has a significantly lower MAE than HAR-X at $h1$, $h5$ and $h22$
...
H=HAR-X, L=LSTM, G=VolGA, on QLIKE and MAE.}
\label{tab:dm}
\footnotesize
\setlength{\tabcolsep}{5pt}
\begin{tabular}{ll cc cc}
\toprule
& & \multicolumn{2}{c}{LSTM vs HAR-X} & \multicolumn{2}{c}{VolGA vs LSTM} \\
