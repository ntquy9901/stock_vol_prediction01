...
has no effect. The graph is therefore a thin-market cross-sectional denoising effect rather than a
universal one.
...
\textbf{Leaf-cooccurrence graph (VolTree).} The graph reuses the fitted booster to denoise its own
...
Table~\ref{tab:summary} summarises the headline metrics (MSE, RMSE, MAE, QLIKE) across both markets: the final model VolTree posts the best value on every metric at every horizon in both, ahead of all three baselines. Table~\ref{tab:detail} reports all four metrics for both markets across GARCH, HAR, the learned
...
final model VolTree (endogenous XGBoost with the earnings block and leaf-graph smoothing). All four
...
Table~\ref{tab:detail}). The final model attains the best value on every metric at every
...
1 & VolTree & \textbf{0.541} & \textbf{0.735} & \textbf{0.202} & \textbf{0.317} & \textbf{0.534} & \textbf{0.731} & \textbf{0.391} & \textbf{1.565} \\
\midrule
...
5 & VolTree & \textbf{0.599} & \textbf{0.774} & \textbf{0.218} & \textbf{0.371} & \textbf{0.578} & \textbf{0.760} & \textbf{0.424} & \textbf{1.647} \\
\midrule
...
10 & VolTree & \textbf{0.617} & \textbf{0.786} & \textbf{0.225} & \textbf{0.392} & \textbf{0.595} & \textbf{0.771} & \textbf{0.439} & \textbf{1.682} \\
\midrule
...
22 & VolTree & \textbf{0.609} & \textbf{0.780} & \textbf{0.228} & \textbf{0.407} & \textbf{0.621} & \textbf{0.788} & \textbf{0.460} & \textbf{1.726} \\
\bottomrule
\end{tabular}
\end{table}
...
1 & XGB+E    & 0.541 & 0.736 & 0.202 & \textbf{0.317} & 0.535 & 0.731 & 0.393 & 1.569 \\ % SP500 leaf_graph_sp500_h1.json metrics.XGB | HOSE leaf_graph_hose_h1.json metrics.XGB
1 & VolTree & \textbf{0.541} & \textbf{0.735} & \textbf{0.202} & 0.317 & \textbf{0.534} & \textbf{0.731} & \textbf{0.391} & \textbf{1.565} \\ % SP500 leaf_graph_sp500_h1.json metrics.XGB+leafgraph (leaf inert, DM p=0.66) | HOSE leaf_graph_hose_h1.json metrics.XGB+leafgraph (DM +0.25% p=3.6e-4, spike-robust)
\midrule
...
5 & XGB+E    & \textbf{0.599} & \textbf{0.774} & 0.219 & \textbf{0.371} & 0.579 & 0.761 & 0.426 & 1.651 \\ % SP500 leaf_graph_sp500_h5.json metrics.XGB | HOSE leaf_graph_hose_h5.json metrics.XGB
5 & VolTree & 0.599 & 0.774 & \textbf{0.218} & 0.371 & \textbf{0.578} & \textbf{0.760} & \textbf{0.424} & \textbf{1.647} \\ % SP500 leaf_graph_sp500_h5.json metrics.XGB+leafgraph | HOSE leaf_graph_hose_h5.json metrics.XGB+leafgraph (DM +0.26% p=3.1e-5, spike-robust)
\midrule
...
10 & HAR      & 0.621 & 0.788 & 0.236 & 0.461 & 0.666 & 0.816 & 0.525 & 1.828 \\ % SP500 full_compare_sp500.json h10 metrics.HAR (mse 6.2137e-7, rmse 7.8827e-4, mae 2.3561e-4, qlike 0.46150) | HOSE full_compare_hose.json h10 metrics.HAR (mse 6.6598e-7, rmse 8.1607e-4, mae 5.2496e-4, qlike 1.82766)
...
10 & XGB      & 0.631 & 0.794 & 0.232 & 0.431 & 0.595 & 0.771 & \textbf{0.439} & \textbf{1.682} \\ % SP500 leaf_graph_paper_sp500_noearn_h10.json metrics.XGB (n_folds=8; mse 6.3082e-7, rmse 7.9424e-4, mae 2.3245e-4, qlike 0.43112) | HOSE leaf_graph_paper_hose_noearn_h10.json metrics.XGB (n_folds=8; mse 5.9463e-7, rmse 7.711e-4, mae 4.389e-4=0.438897 min, qlike 1.6816=1.681571 min)
...
10 & XGB+E    & \textbf{0.616} & \textbf{0.785} & 0.225 & \textbf{0.392} & 0.595 & 0.771 & 0.441 & 1.684 \\ % SP500 leaf_graph_sp500_h10.json metrics.XGB | HOSE leaf_graph_hose_h10.json metrics.XGB
10 & VolTree & 0.617 & 0.786 & \textbf{0.225} & 0.392 & \textbf{0.595} & \textbf{0.771} & 0.439 & 1.682 \\ % SP500 leaf_graph_sp500_h10.json metrics.XGB+leafgraph | HOSE leaf_graph_hose_h10.json metrics.XGB+leafgraph (mse 5.9462e-7/rmse 7.7111e-4 min; MAE 0.439102>XGB 0.438897 so MAE bold=XGB; leaf DM vs XGB+E +0.12% p=4.6e-3, spike-robust)
\midrule
...
22 & XGB      & 0.623 & 0.789 & 0.236 & 0.446 & 0.621 & 0.788 & \textbf{0.459} & \textbf{1.725} \\ % SP500 leaf_graph_paper_sp500_noearn_h22.json metrics.XGB (n_folds=8; mse 6.2256e-7, rmse 7.8903e-4, mae 2.3593e-4, qlike 0.44595) | HOSE leaf_graph_paper_hose_noearn_h22.json metrics.XGB (n_folds=8; mse 6.2128e-7, rmse 7.882e-4, mae 4.591e-4, qlike 1.7251) -- endogenous is min QLIKE/MAE at h22 (earnings inert)
...
22 & XGB+E    & \textbf{0.609} & \textbf{0.780} & \textbf{0.228} & \textbf{0.407} & 0.622 & 0.789 & 0.461 & 1.727 \\ % SP500 leaf_graph_sp500_h22.json metrics.XGB (leaf alpha=0, identical) | HOSE leaf_graph_hose_h22.json metrics.XGB
22 & VolTree & 0.609 & 0.780 & 0.228 & 0.407 & \textbf{0.621} & \textbf{0.788} & 0.460 & 1.726 \\ % SP500 leaf_graph_sp500_h22.json metrics.XGB+leafgraph (alpha=0) | HOSE leaf_graph_hose_h22.json metrics.XGB+leafgraph (leaf gain ns, DM p=0.34)
\bottomrule
\end{tabular}
\end{table}
...
earnings-neutral endogenous XGB is the column minimum, as at $h22$).
...
the endogenous model, Table~\ref{tab:detail}) gains 0.22\%
at $h1$ (DM $p<0.001$) and 0.12\% at $h5$ (DM $p<0.001$) over the endogenous XGB --- matching VolTree,
because HOSE earnings are inert (XGB+E $=$ XGB).
