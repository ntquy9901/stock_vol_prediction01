...
early stopping in its official code. The graph null replicates on a second market, 405 Vietnam HOSE tickers,
...
is a test-set early-stopping artifact. A replication on 405 Vietnam HOSE tickers confirms the graph null on a
second market and shows the earnings lever is specific to the S&P 500 and does not transfer to Vietnam under
