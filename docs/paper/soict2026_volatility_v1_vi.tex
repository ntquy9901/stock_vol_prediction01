...
%   docs/paper/volatility_paper_draft_3seed.md (nguồn số liệu/bảng chuẩn).
...
thay vì hàm mục tiêu QLIKE mà tài liệu ghi công cho việc thu hẹp khoảng cách HAR.
...
hơn hoặc bằng có ý nghĩa so với mô hình đầy đủ tại h1, h5, và h22. Với một thị trường mới nổi Việt Nam, nghiên
