...
→ **Gap cũ đã hết**: 2016 từng chỉ 18 bài (LOW) → giờ 391. 2021-2026 đều 1.484-2.486 — **đều giữa các năm**. Ở cấp số bài, KHÔNG còn thưa.

**(b) Mật độ per-stock-day (metric thật cho model) — VẪN RẤT THƯA:**

| Năm | bài | match ticker¹ | stock-day có tin² | tổng stock-day³ | **coverage** |
|-----|-----|---------------|-------------------|-----------------|--------------|
| 2008 | 183 | 4 | 4 | 1,718 | **0.2%** |
| 2009 | 203 | 4 | 4 | 2,366 | **0.2%** |
| 2010 | 392 | 19 | 18 | 3,109 | **0.6%** |
| 2011 | 758 | 33 | 32 | 3,305 | **1.0%** |
| 2012 | 387 | 27 | 27 | 3,908 | **0.7%** |
| 2013 | 504 | 39 | 40 | 4,000 | **1.0%** |
| 2014 | 513 | 43 | 43 | 4,304 | **1.0%** |
| 2015 | 513 | 58 | 58 | 4,464 | **1.3%** |
| 2016 | 391 | 43 | 42 | 4,540 | **0.9%** |
| 2017 | 369 | 37 | 37 | 5,519 | **0.7%** |
| 2018 | 389 | 84 | 82 | 6,862 | **1.2%** |
| 2019 | 725 | 229 | 566 | 7,242 | **7.8%** |
| 2020 | 1,352 | 365 | 517 | 7,283 | **7.1%** |
| 2021 | 1,683 | 386 | 387 | 7,445 | **5.2%** |
| 2022 | 1,594 | 353 | 323 | 7,470 | **4.3%** |
| 2023 | 1,484 | 305 | 292 | 7,470 | **3.9%** |
| 2024 | 1,601 | 396 | 363 | 7,500 | **4.8%** |
| 2025 | 1,685 | 411 | 389 | 7,470 | **5.2%** |
| 2026 ⁴ | 2,486 | 584 | 483 | 3,120 | **15.5%** |

¹ bài match ≥1 mã VN30 (title+lead). Toàn dataset: **19.9%** (title-only: 16.7%)  
² unique (ticker, date) có tin — đơn vị model dùng  
³ tổng (ticker, ngày giao dịch) từ lịch giá VN30  
⁴ 2026 đang partway (mới ~3.120 stock-day đầu năm) → coverage 15.5% là ước lượng thiêu biện

| Split | bài | stock-day có tin | tổng stock-day | **coverage** |
|-------|-----|------------------|----------------|--------------|
| Train (<2020) | 5,335 | 953 | 51,337 | **1.9%** |
| Val (2020-2021) | 3,035 | 904 | 14,728 | **6.1%** |
| Test (>=2021) | 10,533 | 2,237 | 40,475 | **5.5%** |

**Verdict trung thực:**
- ✅ **Cấp số bài**: gap đã lấp, phân bố đều 2008-2026. Vấn đề 'test mù tin' (Mục 10 #1) **đã giải quyết ở cấp article** — có tin trong test period.
- 🔴 **Cấp per-stock-day**: **VẪN CỰC THƯA** — chỉ **5.5%** stock-day trong test có tin ticker-specific (94.5% = 0 tin). Nguyên nhân gốc: chỉ ~20% bài match mã VN30 cụ thể (đa số tin vĩ mô/market-wide).
- → Thêm bài (`vnstock` 14.825 raw → chỉ 432 unique) **không đặc lên**: bottleneck là match-rate ~20%, không phải số bài.
- → Đây là lý do **các kĩ thuật thầy gợi ý vẫn cần thiết**: embedding (rút thêm tín hiệu từ ít bài có match) + latent/missing-modality (vì 94.5% stock-day vẫn mù tin) + market-level fallback. Xem `SENTIMENT_LATENT_SPACE_TECHNIQUES.md` & `SENTIMENT_NEWS_EMBEDDING_ARCHITECTURE.md`.
