...
## Result headline
**HARQ (realized-quarticity measurement-error correction, Bollerslev–Patton–Quaedvlieg 2016) significantly
beats HAR-X at 7 of 8 market×horizon cells** on the exact canonical walk-forward folds — the first lever that
produces a statistically significant long-horizon improvement. Gains are small but consistent/significant.
