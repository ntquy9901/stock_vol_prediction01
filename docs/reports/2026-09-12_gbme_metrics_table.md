...
GBM = gamma-loss Gradient Boosting Machine on own-history features; GBME(GBM+Earning) = GBM + External earnings features; GBME(GBM+Earning)+graph adds the cross-firm correlation-graph neighbour aggregate. QLIKE is the primary loss (equal to the gamma deviance up to a constant); Diebold-Mariano tests use per-trading-date mean loss.
...
*DM:* GBME(GBM+Earning) vs GBM h1 p=0.000 · GBME(GBM+Earning) vs GBM h5 p=0.000 · GBME(GBM+Earning) vs GBM h10 p=0.000 · GBME(GBM+Earning) vs GBM h22 p=0.000 (all significant → GBME(GBM+Earning) bolded; GBME(GBM+Earning)+graph does not significantly improve GBME(GBM+Earning), so graph is not bolded).
...
*DM:* GBME(GBM+Earning) vs GBM h1 p=0.000 · GBME(GBM+Earning) vs GBM h5 p=0.214 · GBME(GBM+Earning) vs GBM h10 p=0.122 · GBME(GBM+Earning) vs GBM h22 p=0.919 (earnings does not beat GBM → own-history GBM is the best legal model and is bolded; graph adds nothing).
