...
| Check | Status | Detail |
| --- | --- | --- |
| LINT | FAIL | Found 811 errors. |
| TESTS | FAIL | 4 skipped, 1 error in 8.02s |
| SCHEMA | PASS | 34/34 artifacts valid |
| DRIFT | INFO | ACB_processed.csv: ref=2800/cur=1200 rows -> C:\luanvan\stock_vol_prediction01\results\quality_gate\2026-08-08_152716\drift.html |
